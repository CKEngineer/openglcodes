...
int main()
{
    ...
    GLfloat time;
    GLfloat time_float = glGetUniformLocation(shaderProgram.ID,"u_time");
	GLfloat resolution_float = glGetUniformLocation(shaderProgram.ID,"u_resolution");
	...
	glUniform2f(resolution_float,SCR_WIDTH,SCR_HEIGHT);	
