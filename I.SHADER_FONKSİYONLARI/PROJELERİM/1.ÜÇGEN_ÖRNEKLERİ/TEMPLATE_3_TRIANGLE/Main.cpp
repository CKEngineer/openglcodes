...
GLfloat vertices[] =
{
	-0.8f, -0.8f * (1.7f) / 3, /*Lower left corner */ 0.8f,0.0f,0.0f,
	0.8f, -0.8f * (1.7f) / 3, /* Lower right corner */0.0f, 0.8f, 0.0f,
	0.0f, 0.8f * (1.7f) * 2 / 3, /* Upper corner */ 0.0f,0.0f,0.8f,
	-0.8f / 2, 0.8f * (1.7f) / 6, /* Inner left */ 0.8f,0.8f,0.0f,
	0.8f / 2, 0.8f * (1.7f) / 6, /* Inner right */ 0.0f,0.8f,0.8f,
	0.0f, -0.8f * (1.7f) / 3, /* Inner down */     0.8f,0.0f,0.8f
};
