...
GLfloat vertices[] =
{
    -0.7f, 0.7f, /* Üst sol noktası */ 1.0f,0.0f,0.0f,//KIRMIZI
	 0.7f, 0.7f, /* Üst sağ noktası */ 1.0f,0.0f,0.0f,//KIRMIZI

	 0.7f, 0.7f, /* Üst sağ noktası */ 0.0f,1.0f,0.0f,//YEŞİL
	 0.7f, -0.7f, /* Alt sağ noktası */0.0f,1.0f, 0.0f,//YEŞİL

	 0.7f, -0.7f, /* Alt sağ noktası */0.0f,0.0f,1.0f,//MAVİ
	-0.7f, -0.7f, /* Alt sol noktası */0.0f,0.0f,1.0f,//MAVİ
	
	-0.7f, -0.7f, /* Alt sol noktası */1.0f, 1.0f, 0.0f,//SARI
	-0.7f,  0.7f, /* Üst sol noktası */1.0f, 1.0f, 0.0f//SARI
};
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "glLineWidth funtion example", NULL, NULL);
